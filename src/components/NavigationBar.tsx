...
const NavigationLink = (props: INavigationLinkProps) => {
  const { children, href, isActive, target = "_self" } = props;
      ...
      <Button
        ...
        className={`text-base duration-300 w-full ${
          isActive
            ...
            : "text-primary/50 group-hover:text-primary font-normal"
        }`}
      >
        {children}
      </Button>
...
const links = [
  ...
  {
    href: "https://dev.to/arzaqulmughny",
    name: "Blog",
    target: "_blank",
  },
  {
