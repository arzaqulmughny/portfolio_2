  ...
  return (
    <footer className="flex justify-between max-w-3xl px-3 py-2 mx-auto border-t bg-background dark:border-t-neutral-800 border-t-neutral-100">
      ...
      <div className="flex gap-x-4">
        <a href="https://instagram.com/arza.dev" target="_blank">
          <Button variant={"ghost"} className="stroke-1">
            <div className="w-6 aspect-square fill-primary">
              <Instagram />
            </div>
          </Button>
        </a>
        <a href="https://github.com/arzaqulmughny" target="_blank">
          <Button variant={"ghost"}>
            <div className="w-6 aspect-square fill-primary">
              <Github />
            </div>
        ...
        <a href="http://linkedin.com/in/arzaqul" target="_blank">
          <Button variant={"ghost"}>
            <div className="w-6 aspect-square fill-primary">
              <LinkedIn />
            </div>
